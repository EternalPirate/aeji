...
var HistoryService = /** @class */ (function () {
    function HistoryService(userService, angularFirestore) {
        var _this = this;
    ...
    HistoryService.prototype.pushToHistory = function (item) {
        this.db
            .collection(this.storageKey)
            .add(item);
    };
    HistoryService.prototype.getHistoryList = function (limit) {
        return this.db
...
var QueuesService = /** @class */ (function () {
    function QueuesService(userService, angularFirestore) {
        var _this = this;
        this.userService = userService;
        this.angularFirestore = angularFirestore;
        this.storageKey = 'queues';
        this.storageCollectionKey = 'list';
        this.userService.user.subscribe(function (user) {
            if (user) {
                _this.db = _this.angularFirestore
                    .collection('users')
                    .doc(user.id)
                    .collection(_this.storageKey);
            }
        });
    }
    ...
    QueuesService.prototype.getQueueListById = function (id, limit) {
        return this.db
            .doc(id)
    ...
    QueuesService.prototype.getQueueByIdSub = function (id) {
        return this.db
            .doc(id)
            .valueChanges();
    };
    ...
    QueuesService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_user_service__WEBPACK_IMPORTED_MODULE_3__["UserService"],
