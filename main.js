...
var map = {
	"./pages/history/history.module": [
		...
		"default~pages-history-history-module~pages-home-home-module~pages-login-login-module~pages-queue-que~de8c8ad4",
		"common",
		"pages-history-history-module"
	],
...
var routes = [
    { path: '', canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_3__["AuthGuardService"]], pathMatch: 'full', loadChildren: './pages/home/home.module#HomePageModule' },
    { path: 'login', loadChildren: './pages/login/login.module#LoginPageModule' },
    { path: 'queue/:id', canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_3__["AuthGuardService"]], loadChildren: './pages/queue/queue.module#QueuePageModule' },
    { path: 'history', canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_3__["AuthGuardService"]], loadChildren: './pages/history/history.module#HistoryPageModule' },
    { path: 'settings', canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_3__["AuthGuardService"]], loadChildren: './pages/settings/settings.module#SettingsPageModule' },
];
...
module.exports = "<ion-app>\n  <ion-split-pane>\n    <ion-menu *ngIf=\"user\" menuId=\"menu\">\n      <ion-header>\n        <ion-toolbar>\n          <ion-title>\n            <ion-chip color=\"light\" no-margin>\n              <ion-avatar>\n                <img [src]=\"user.picture\">\n              </ion-avatar>\n              <ion-label>\n                {{ user.name }}\n              </ion-label>\n            </ion-chip>\n          </ion-title>\n        </ion-toolbar>\n      </ion-header>\n      <ion-content>\n        <ion-list>\n          <ion-menu-toggle autoHide=\"false\" *ngFor=\"let p of appPages\">\n            <ion-item [routerDirection]=\"'root'\" [routerLink]=\"[p.url]\">\n              <ion-icon [name]=\"p.icon\" slot=\"start\" color=\"light\"></ion-icon>\n              <ion-label>\n                {{p.title}}\n              </ion-label>\n            </ion-item>\n          </ion-menu-toggle>\n\n\n          <ion-menu-toggle autoHide=\"false\">\n            <ion-item (click)=\"logOut()\">\n              <ion-icon name=\"power\" slot=\"start\" color=\"light\"></ion-icon>\n              <ion-label>\n                sign out\n              </ion-label>\n            </ion-item>\n          </ion-menu-toggle>\n        </ion-list>\n      </ion-content>\n    </ion-menu>\n    <ion-router-outlet main></ion-router-outlet>\n  </ion-split-pane>\n</ion-app>\n"
...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, userService, storage, router, menuController) {
    ...
    AppComponent.prototype.initializeApp = function () {
        ...
        this.platform.ready().then(function () {
            ...
            _this.userService.user.subscribe(function (user) {
                _this.user = user;
                _this.menuController.enable(Boolean(user), 'menu');
            });
        });
    };
...
/* harmony import */ var _modals_image_image_page__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./modals/image/image.page */ "./src/app/modals/image/image.page.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _modals_image_image_page__WEBPACK_IMPORTED_MODULE_17__["ImagePage"]
            ],
            entryComponents: [
                _modals_image_image_page__WEBPACK_IMPORTED_MODULE_17__["ImagePage"]
            ],
            ...
            providers: [
                ...
                _angular_fire_auth__WEBPACK_IMPORTED_MODULE_12__["AngularFireAuth"],
                {
                    ...
                    useFactory: function (ds) { return function () { return ds.initDb(); }; },
                    deps: [_services_user_service__WEBPACK_IMPORTED_MODULE_18__["UserService"]],
                    multi: true
                },
...
/***/ "./src/app/modals/image/image.page.html":
/*!**********************************************!*\
  !*** ./src/app/modals/image/image.page.html ***!
  \**********************************************/
/*! no static exports found */
...
module.exports = "<ion-header>\n  <ion-toolbar>\n    <ion-title>{{ help.title }}</ion-title>\n\n    <ion-buttons (click)=\"modalController.dismiss()\" slot=\"end\">\n      <ion-button><ion-icon name=\"close\"></ion-icon></ion-button>\n    </ion-buttons>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content scrollX>\n  <img [src]=\"help.image\" alt=\"\" class=\"image-height\"/>\n</ion-content>\n"

/***/ }),

/***/ "./src/app/modals/image/image.page.scss":
/*!**********************************************!*\
  !*** ./src/app/modals/image/image.page.scss ***!
  \**********************************************/
/*! no static exports found */
...
module.exports = ".image-height {\n  height: 100%;\n  max-width: none; }\n\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/modals/image/image.page.ts":
/*!********************************************!*\
  !*** ./src/app/modals/image/image.page.ts ***!
  \********************************************/
...
var ImagePage = /** @class */ (function () {
    function ImagePage(modalController) {
    ...
    ], ImagePage.prototype, "help", void 0);
    ImagePage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-image',
            template: __webpack_require__(/*! ./image.page.html */ "./src/app/modals/image/image.page.html"),
            styles: [__webpack_require__(/*! ./image.page.scss */ "./src/app/modals/image/image.page.scss")]
        }),
...
var AuthGuardService = /** @class */ (function () {
    function AuthGuardService(userService, storage, router) {
        this.userService = userService;
        this.storage = storage;
        this.router = router;
    }
...
var UserService = /** @class */ (function () {
    function UserService(angularFirestore, storage) {
        var _this = this;
        ...
        this.user.subscribe(function (user) {
            if (user) {
                _this.db = _this.angularFirestore
                    .collection('users')
                    .doc(user.id);
            }
        });
    }
    UserService.prototype.initDb = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var user;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    UserService.prototype.setSettings = function (settings) {
        this.db.set({ settings: settings }, { merge: true });
    };
...
var environment = {
    ...
    firebase: {
        ...
        authDomain: 'aeji-dfdff.firebaseapp.com',
        databaseURL: 'https://aeji-dfdff.firebaseio.com',
        projectId: 'aeji-dfdff',
        storageBucket: 'aeji-dfdff.appspot.com',
        messagingSenderId: '617120131709',
        appId: '1:617120131709:web:054d47a243622fd9'
    }
};
/*
...
module.exports = __webpack_require__(/*! /home/travis/build/gchronos/aeji/src/main.ts */"./src/main.ts");
