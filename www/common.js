...
var HistoryService = /** @class */ (function () {
    function HistoryService(angularFirestore) {
...
var QueuesService = /** @class */ (function () {
    function QueuesService(angularFirestore) {
        this.angularFirestore = angularFirestore;
        this.storageKey = 'queues';
        this.storageCollectionKey = 'videoQueue';
        this.db = this.angularFirestore.collection(this.storageKey);
    }
    ...
    QueuesService.prototype.getQueueByIdSub = function (id, limit) {
