                ...
                switch (_c.label) {
                    ...
                    case 1:
                        docs = (_c.sent())
                            .docs;
                        if (docs.length > 0) {
                            this.historySnapshot = (_a = this.historySnapshot).concat.apply(_a, docs);
                            this.history = (_b = this.history).concat.apply(_b, docs.map(function (item) { return item.data(); }));
                        }
                        _c.label = 2;
